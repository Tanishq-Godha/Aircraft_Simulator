...
#include <windows.h>
#include <xinput.h>
extern XINPUT_STATE controllerState;
...
extern float cameraTrauma;

// Weather control (0=Dynamic, 1=Clear, 2=Cloudy, 3=Foggy)
extern int weatherMode;

// Event-Driven Twin Towers
extern bool spawnTwinTowers;
extern float twinTowerX;
extern float twinTowerZ;
extern float twinTowerAnim;  // 0.0f to 1.0f
extern int twinTowerState;   // 0=hidden, 1=rising, 2=full
